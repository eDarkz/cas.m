...
export default function MedalliaCalculatorStandalone() {
      ...
      <div className="max-w-4xl mx-auto p-4 py-8">
        <div className="bg-white rounded-xl shadow-2xl overflow-hidden">
          <div className="bg-blue-900 text-white p-6">
            <h1 className="text-3xl font-bold">Calculadora de Objetivo Medallia</h1>
            <p className="text-sm opacity-90 mt-2">Proyección de Métricas y Análisis de Impacto</p>
          </div>
                    ...
                    <div className="mb-6">
                      ...
                      <div className="flex items-center justify-center text-2xl my-6">
                        <div className="inline-flex flex-col items-center ">
                          <div className="pb-1 px-2 border-b-2 border-black mx-2">{Math.round(results.currentYes)} + <strong className="text-blue-900">X</strong></div>
